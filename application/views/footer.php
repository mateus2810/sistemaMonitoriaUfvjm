...
<!-- jvectormap -->
<script src="<?= base_url('/AdminLTE-2.4.3/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js');?>"></script>
<script src="<?= base_url('/AdminLTE-2.4.3/plugins/jvectormap/jquery-jvectormap-world-mill-en.js');?>"></script>
<!-- jQuery Knob Chart -->
