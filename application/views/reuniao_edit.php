        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?= $aula->id_atividade == "" ? "Novo" : "Editar" ?> Reunião</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form" action="<?php echo site_url('Monitoria/reuniao_editar/'.$aula->id_monitoria); ?>" method="post">
                        <div class="box-body">
                            <input type="hidden" name="id_atividade" value="<?=$aula->id_atividade?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input class="form-control pull-right"value="<?php echo date('Y-m-d');?>" type="date"  name="data" required>                                        </div>
                                    </div>
                                </div>
                                <!-- /.col -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="descricao" placeholder="Entre a descrição da atividade realizada" value="<?=$aula->descricao?>">
                            </div>
